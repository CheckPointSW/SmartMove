...
namespace CiscoMigration
{
    ...
    public class CiscoConverter : VendorConverter
    {
        ...
        private class CiscoNetwork
        {
            ...
            public bool IsHost()
            {
                return NetworkUtils.IsValidIp(IpAddress) && (NetworkUtils.GetMaskLength(NetMask) == 32);
            }

            public bool IsNetwork()
            {
                return NetworkUtils.IsValidIp(IpAddress) && NetworkUtils.IsValidNetmask(NetMask) && (NetworkUtils.GetMaskLength(NetMask) < 32);
            }
