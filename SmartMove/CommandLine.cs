...
namespace SmartMove
{
    ...
    class CommandLine
    {
        ...
        public int DisplayHelp()
        {
            ...
            Console.WriteLine("\t" + "-k | --skip" + "\t\t" + @"(""-k false"" |"" -k true"" [default]) do not import unused objects (for FortiNet, PaloAlto, CiscoASA, Panorama and JuniperSRX only) [enabled by default]");
        ...
        public int CheckOptionsValidity(CommandLine commandLine)
        {
            ...
            var vendorsList2 = new List<string> { "FortiNet", "PaloAlto", "Panorama", "CiscoASA", "JuniperSRX" };                               //option -k
